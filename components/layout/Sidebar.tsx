...
const navItems = [
  ...
  { href: "/prospects", label: "Prospects", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
  ...
  { href: "/renewals", label: "Renewals", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  { href: "/ai-search", label: "AI Assistant", icon: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" },
  ...
  { href: "/analytics", label: "Analytics", icon: "M3 17l6-6 4 4 8-8M21 7v6h-6" },
  ...
  { href: "/attendance", label: "Attendance", icon: "M12 8v4l3 3m-3-13a9 9 0 100 18 9 9 0 000-18z" },
        ...
        {navItems.filter(item => !hiddenItems.includes(item.href)).map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href} className={`sidebar-link${isActive ? " active" : ""}`}>
              <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
