    ...
    <div style={{
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(0,80,30,0.25) 0%, transparent 70%)",
      ...
      {[...Array(12)].map((_, i) => (
        <div key={i} style={{
          ...
          height: i % 3 === 0 ? 3 : 2,
          borderRadius: "50%",
          background: `rgba(34,197,94,${0.3 + (i % 4) * 0.1})`,
          left: `${8 + i * 8}%`,
          top: `${10 + (i * 17 % 80)}%`,
      ...
      <div style={{
        ...
        boxShadow: "0 0 0 1px rgba(21,128,61,0.15), 0 32px 80px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.06)",
        overflow: "hidden",
      }}>
        ...
        <div style={{ padding: "36px 36px 28px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 8 }}>
            <div style={{
              ...
              <img src="/logo-dark.png" alt="CS Hub" style={{ width: 170, objectFit: "contain", display: "block", filter: "drop-shadow(0 0 12px rgba(34,197,94,0.3))" }} />
            </div>
          </div>

          {/* Welcome */}
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            <div style={{ fontSize: 11, fontWeight: 600, color: "rgba(34,197,94,0.7)", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 8 }}>
              Client Success Platform
            </div>
            <div style={{ fontSize: 20, fontWeight: 700, color: "rgba(255,255,255,0.92)", marginBottom: 6, letterSpacing: "-0.02em" }}>
              Welcome back
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = "rgba(0,120,212,0.15)"; e.currentTarget.style.borderColor = "rgba(0,120,212,0.5)"; e.currentTarget.style.transform = "translateY(-1px)"; }}
            ...
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = "rgba(66,133,244,0.15)"; e.currentTarget.style.borderColor = "rgba(66,133,244,0.5)"; e.currentTarget.style.transform = "translateY(-1px)"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "rgba(255,255,255,0.06)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.1)"; e.currentTarget.style.transform = "translateY(0)"; }}
            >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "20px 0 0" }}>
            ...
            <span style={{ fontSize: 10, color: "rgba(255,255,255,0.25)", fontWeight: 600, letterSpacing: "0.1em" }}>SECURED BY OAUTH 2.0</span>
            <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.08)" }} />
          </div>
        </div>

        {/* Footer */}
        <div style={{ padding: "14px 36px 24px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ display: "flex", gap: 8, alignItems: "flex-start", marginBottom: 8 }}>
            <svg width="12" height="12" fill="none" stroke="rgba(34,197,94,0.6)" strokeWidth={2} viewBox="0 0 24 24" style={{ flexShrink: 0, marginTop: 1 }}>
        ...
        <div style={{
          height: 1,
          background: "linear-gradient(90deg, transparent, rgba(21,128,61,0.4), transparent)",
        }} />
      </div>
      ...
      <style>{`
        ...
        @keyframes logoGlow {
          from { filter: drop-shadow(0 0 16px rgba(34,197,94,0.3)) drop-shadow(0 0 32px rgba(21,128,61,0.15)); }
          to { filter: drop-shadow(0 0 28px rgba(34,197,94,0.55)) drop-shadow(0 0 56px rgba(21,128,61,0.3)); }
        }
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div style={{ minHeight: "100vh", background: "#050a05" }} />}>
      <LoginContent />
    </Suspense>
  );
}
